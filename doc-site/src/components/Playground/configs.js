export const componentConfigs = {
  Badge: {
    title: "_Badge",
    props: [
      { name: "label", label: "Label Text", type: "string", default: "جديد" },
      {
        name: "bgColor",
...
${razorItems}
  ...
  InputField: {
    ...
    props: [
      ...
      { name: "id", label: "Input ID", type: "string", default: "user-email" },
    ],
    renderRazor: (props) =>
...
${props.optionsRaw
  ...
  DateInput: {
    ...
    props: [
      ...
      { name: "id", label: "Input ID", type: "string", default: "birth-date" },
    ],
    renderRazor: (props) =>
  ...
  AttachBox: {
    ...
    props: [
      ...
      { name: "id", label: "Box ID", type: "string", default: "comm-reg-box" },
    ],
    renderRazor: (
      props,
  ...
  AttachmentCard: {
    ...
    props: [
      ...
      { name: "id", label: "Card ID", type: "string", default: "id-card-view" },
    ],
    renderRazor: (
      props,
...
<script>
  (function() {
    ...
    const options = {
      ${props.searchable ? 'search: { containerSelector: "#tableActions", placeholder: "بحث عام..." },' : ''}
