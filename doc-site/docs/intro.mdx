...
- 🌐 **First-Class LTR & RTL**: Native bidirectional engine built for seamless Arabic and multilingual enterprise applications.
- ♿ **100% ARIA Accessible**: Full keyboard traps, focus indicators, and screen reader announcements compliant with WCAG 2.1 AA.
- 🌙 **Automatic Dark Mode**: Built-in CSS custom properties (`--momah-*`) supporting light and dark themes dynamically.
